...
public class SseAlarmService implements MessageListener {
    ...
    public SseAlarmService(SseEmitterRegistry sseEmitterRegistry, @Qualifier("ssePubSub") RedisTemplate<String, String> ssePubSubTemplate) {
    ...
    public void publishOrderingMessage(String receiver, String sender, Long orderingId, OrderStatus orderStatus) {
        ...
        if (emitter == null) {
            ssePubSubTemplate.convertAndSend("ordering", data);
            return;
        }
